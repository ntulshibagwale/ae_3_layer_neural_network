# Code copied from ae_measure2.py
...
def wave2vec(dt, waveform, lower, upper, d, FFT_units, upsample=10001):
    '''
    ...
    interval_width = int(len(upsampled_z)/d) # NOTE: range of index that is integrated over
    true_bounds = []
